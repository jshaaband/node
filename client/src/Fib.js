...
class Fib extends Component {
  ...
  renderSeenIndexes() {
    return this.state.seenIndexes.map(({ number }) => {
        return (
            <Message severity="contrast" text={number}></Message>
        )
    });
  }
    ...
    render() {
        ...
        <div className="surface-0 text-700 text-center pt-5">
            <div className="text-900 font-bold text-3xl mb-3">Enter your index</div>
        </div>
                <div
                    className="text-700 mb-2">Ac turpis egestas maecenas pharetra convallis posuere morbi leo urna.</div>
        ...
        <h3>Indexes I have seen:</h3>
            <div className="card flex flex-wrap align-items-center justify-content-center gap-3">
                ...
                <div className="text-blue-600 text-sm font-bold m-3"><i
                    className="pi pi-calculator"></i>&nbsp;My Fib calculator</div>
      </div>
        );
    }
}
